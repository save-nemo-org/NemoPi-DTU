...
-- GPS used to live here as sensors.infrastructure.Gps (modbus-attached only).
-- It's been moved out to src/gps.lua so the three carrier boards can each
-- pick their own backend (on_chip / on_board / modbus / none). nemopi.lua
-- now calls gps.location() in the diagnosis block.
